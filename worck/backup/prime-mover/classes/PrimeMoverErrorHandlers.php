...
class PrimeMoverErrorHandlers
{
    ...
    public function initHooks()
    {
        ...
        add_action('prime_mover_shutdown_actions', [$this, 'primeMoverDeletePackagePath'], 15 );
        ...
        add_action('init', [$this, 'streamError'], 1);
    ...
    public function streamError()
    {
        ...
        if (! wp_verify_nonce($params['prime_mover_errornonce'], 'prime_mover_errornonce' . $blog_id)) {
            return;
        }
    ...
    public function primeMoverLogExist()
    {
        ...
        if ( ! wp_verify_nonce($error_post['prime_mover_errorlog_nonce'], 'prime_mover_errorlog_nonce')) {
            wp_die();
        }
     ...
     */
    public function primeMoverDeletePackagePath()
    {
        if (! $this->getSystemAuthorization()->isUserAuthorized()) {
            return;
        }
