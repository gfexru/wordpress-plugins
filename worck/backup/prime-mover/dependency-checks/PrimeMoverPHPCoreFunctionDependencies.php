...
class PrimeMoverPHPCoreFunctionDependencies
{
    ...
    private $required_core_functions = array('readfile', 'extension_loaded', 'file_get_contents', 'file_put_contents', 'fopen', 'mysqli_connect', 
        'stream_copy_to_stream', 'finfo_open', 'finfo_file', 'finfo_close', 'openssl_encrypt', 'openssl_cipher_iv_length', 'openssl_random_pseudo_bytes', 
     ...
     * @var array
     */
    private $required_extensions = array('mbstring', 'fileinfo', 'pdo_mysql');
