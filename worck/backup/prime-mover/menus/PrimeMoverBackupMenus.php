...
{     
    ...
    */
    public function initHooks()
    {
        ...
        add_filter('prime_mover_force_backup_refresh', [$this, 'maybeForceBackupRefreshOnChangeVersion'], 10, 2); 
    ...
    /**
     * Maybe force backup refresh on change version
     * @param boolean $refresh
     * @param boolean $markup
     * @return string|boolean
     */
    public function maybeForceBackupRefreshOnChangeVersion($refresh = false, $markup = false)
    {
        ...
        $backup_markup_db_version = $this->getSystemFunctions()->getSiteOption($option, false, true, true);
        
        if ( ! $backup_markup_db_version ) {
            $this->getSystemFunctions()->updateSiteOption($option, $latest_backup_markup, true); 
            return true;
        }
    ...
    public function addRefreshBackupButton()
    {
        ...
        $refresh_url = wp_nonce_url($backup_menu_url, 'refresh_backups_'.$user_id, 'prime_mover_refresh_backups');
    ...
    {
        $ret = false;
        if ('prime-mover_page_migration-panel-backup-menu' === $hook || 'prime-mover_page_migration-panel-backup-menu-network' === $hook) {
            $ret = true;
        }
        return $ret;
    }
    ...
    public function addBackupsMenuPageCallBack()
    {
      ...
      <div class="wrap prime-mover-backup-menu-wrap">
         <h1 class="wp-heading-inline"><?php esc_html_e('Prime Mover Packages', 'prime-mover')?></h1>
         ...
         ?>
             ...
             <a href="<?php echo $this->getCreateExportUrl($blog_id, true); ?>"><?php esc_html_e('Migration Tools', 'prime-mover'); ?></a></p>
         <?php 
         }
         ?>         
