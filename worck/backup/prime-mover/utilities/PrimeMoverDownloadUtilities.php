...
class PrimeMoverDownloadUtilities
{
    ...
    {
        if ( ! $remote_url_request && $this->getSystemAuthorization()->isUserAuthorized() && wp_verify_nonce($nonce, $action)) {
    ...
    {                
        ...
        $script_filename = wp_normalize_path($_SERVER['SCRIPT_FILENAME']);
        $root_filename = trailingslashit(dirname($script_filename));     
        ...
        $new_original_path = $this->getAdjustedPath($root_filename, $wp_abspath, $original_path);
     ...
     * @return string|mixed
     */
    protected function getAdjustedPath($original_path = '', $real_path = '', $given_path = '')
    {
