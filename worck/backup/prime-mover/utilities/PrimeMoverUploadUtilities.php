...
class PrimeMoverUploadUtilities
{
    ...
    public function validateChunkUploadCall(array $uploads_ajax_input, $blog_id = 0)
    {
        ...
        if (! wp_verify_nonce($uploads_ajax_input['prime_mover_uploads_nonce'], 'prime_mover_uploads_nonce')) {
    ...
    public function moveUploadedChunkToUploads(array $uploadedfile, array $upload_overrides, $fileName = '')
    {
        ...
        /**
         * EMERSON EXPERIMENT
         * BUG ON WORDPRESS 5.6 EXTREME PERFORMANCE ISSUE
         * WHEN UPLOADING FILE, IT GETS HANG.
         * WE NEED TO ADD A FILTER THAT SKIPS DIRSIZE CACHE
         */
        ...
        /**
         * EMERSON EXPERIMENT
         * WE ONLY NEED TO SKIP DIRSIZE CACHE WHEN UPLOADING CHUNKS VIA PRIME MOVER 
         * ANYTHING ELSE GOES BACK TO NORMAL
         * 
         */
    ...
    public function skipSlowTransient($skip = false, $transient = '')
    {
        ...
        if ('dirsize_cache' !== $transient) {
            /**
             * EMERSON EXPERIMENT
             * NOT A DIRSIZE CACHE TRANSIENT, SKIP
             */
            return $skip;
        }
        
        /**
         * WE ARE DEALING WITH DIRSIZE_CACHE HERE
         * WE WANT THIS TO SHORT CIRCUIT THE ENTIRE PROCESSING THAT IS HANDLED BY WORDPRESS
         * BECAUSE OF THIS WE WANT TO RETURN null
         */
        return null;        
    }
