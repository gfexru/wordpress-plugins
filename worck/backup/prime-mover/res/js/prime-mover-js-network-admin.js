(function ($) {
	...
	window.PrimeMoverCoreJsObject = {
						...
						entry.readData(function(data, err) {
							...
							myReader.addEventListener("loadend", function(e){
								...
								if (encrypted) {
									...
									$.post( prime_mover_js_ajax_renderer.ajaxurl, data, function(response) {
										if (response.result) {											
					...
					$( "#js-prime-mover-export-dialog-confirm-" + blog_id ).dialog({
						...
						buttons: [
							...
							close: function( event, ui ) {								
								...
								$('#js-prime_mover_exporting_blog_' + blog_id).addClass('button-primary');																	
							},
							open: function( event, ui ) {    
			...
			fetchFileToRestore: function(package_url, blog_id) {
				...
				$.ajax({
					url: prime_mover_js_ajax_renderer.ajaxurl,
					type: 'post',		 			            
					data: data, 
